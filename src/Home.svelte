<main>
    ...
    <body>
        <ul>
            ...
            <p class="has-line-data" data-line-start="6" data-line-end="7"><strong>Project description</strong>:Correlation between the number of children who drop out of school (primary education), the prevalence of HIV in young people between 0-14 years old and the percentage of employed children between 7-14 years old.</p>
            </li>
            <li class="has-line-data" data-line-start="7" data-line-end="8">
            <p class="has-line-data" data-line-start="7" data-line-end="8"><strong>Repository</strong>: <a href="https://github.com/gti-sos/SOS2021-24">gti-sos/SOS2021-24</a></p>
            </li>
